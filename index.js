...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.nmtosg2.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    app.get("/chocolates", async (req, res) => {
      const cursors = chocolateCollection.find();
    ...
    app.put("/chocolates/:id", async (req, res) => {
      ...
      const chocolate = {
        $set: {
          chocolateName: updatedChocolate.chocolateName,
          ...
          production: updatedChocolate.production,
          expire: updatedChocolate.expire,
          chefName: updatedChocolate.chefName,
          chefPhoto: updatedChocolate.chefPhoto,
        },
      };
